        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16">
          <div>
            ...
            <div className="space-y-6">
              {[
                { icon: HiOutlineMail, title: "Email Us", info: "info@orniva.com" },
                { icon: HiOutlinePhone, title: "Call Us", info: "+92 300 0000000" },
                { icon: FaWhatsapp, title: "WhatsApp", info: "+92 300 0000000" },
                { icon: HiOutlineLocationMarker, title: "Location", info: "Pakistan" },
                { icon: HiOutlineClock, title: "Working Hours", info: "Mon - Sat: 10:00 AM - 8:00 PM" },
