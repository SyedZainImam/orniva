...
const placeholderProducts = [
  {
    ...
    slug: { current: "gold-plated-elegant-bangle-set" },
    price: 2499,
    compareAtPrice: 3499,
  ...
  },
  {
    ...
    slug: { current: "crystal-drop-necklace" },
    price: 3999,
    badge: "new" as const,
    images: [],
  },
  {
    ...
    slug: { current: "pearl-stud-earrings" },
    price: 1299,
    compareAtPrice: 1799,
    badge: "sale" as const,
    images: [],
  },
  {
    ...
    slug: { current: "rose-gold-statement-ring" },
    price: 1999,
    images: [],
  },
  {
    _id: "5",
    title: "Kundan Bridal Mala Set",
    slug: { current: "kundan-bridal-mala-set" },
    price: 7499,
  ...
  },
  {
    ...
    slug: { current: "delicate-chain-bracelet" },
    price: 999,
    badge: "new" as const,
    images: [],
  },
  {
    ...
    slug: { current: "antique-jhumka-earrings" },
    price: 2199,
    compareAtPrice: 2999,
    images: [],
  },
  {
    _id: "8",
    title: "Diamond Cut Choker",
    slug: { current: "diamond-cut-choker" },
    price: 4999,
    badge: "bestseller" as const,
    images: [],
  },
